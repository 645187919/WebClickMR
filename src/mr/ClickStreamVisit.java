...
import mr_bean.PageViewsBean;
import mr_bean.VisitBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		FileInputFormat.setInputPaths(job, new Path("F:/weblog/pageviews"));
		FileOutputFormat.setOutputPath(job, new Path("F:/weblog/visitout"));
